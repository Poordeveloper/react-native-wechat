...
Pod::Spec.new do |s|
  s.name         = "RCTWeChat"
  s.version      = "0.1.0"
  s.summary      = "React-Native(iOS/Android) functionalities include WeChat Login, Share, Favorite {QQ: 336021910}"
  ...
  s.description  = <<-DESC
                  React-Native(iOS/Android) functionalities include WeChat Login, Share, Favorite {QQ: 336021910}
                   DESC
